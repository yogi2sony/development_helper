...
class QuotationController extends Controller
{
    ...
    public function generateInvoicePdf($id){
        ...
        $pdf::setHeaderCallback(function($pdf) {
            ...
            $htmlright ='<font style="font-size:16px;background-color: #323639;color:white;padding:4px;"> QUOTATION </font><font style="font-size:16px;padding:4px;background-color: #f1f1f1;"> QN-'.$GLOBALS['invoice_id'].'-'.$GLOBALS['cdate'].' </font>
              <p> <b> '.$GLOBALS['ccdate'].'</b><br>
              <b>Ref No : '.$GLOBALS['invoice_id'].'</b><br>
              <b>Validity : 30 days</b><br>
              <b>Page 1 of '.$pdf->getAliasNbPages().'</b></p>';
